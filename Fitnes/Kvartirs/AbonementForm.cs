    ...
    public partial class AbonementForm : Form
    {
        ...
        void LoadDataFromTable()
        {
            try
            {
                ...
                dataAdapter.SelectCommand = new SqlCommand("Select * from tAbonement Order by abonement_name", connection);
                ...
                dgvTypeTO.Columns[1].HeaderText = "Абонемент";
                dgvTypeTO.Columns[2].HeaderText = "Цена";
                dgvTypeTO.Columns[3].HeaderText = "количество часов";
        ...
        {
            bs1.Filter = "abonement_name LIKE '%" + toolStripTextBox1.Text + "%'";
        }
